...
<html>
    ...
    <body background="img/morado.jpg">
        ...
        <div class="container">
            ...
            <hr>
        <img class= "mb-4" src="img/logo.png" align="left" width="65" height="57"/><h1>CORPORACION BANTANG S.A de CV </h1>
        ...
        <table class="table table-bordered" width="20px" >
            ...
            <center><td>Telefono: </td></center>
            <center><td>CEO: </td></center>
            <center><td>E-mail: </td></center>
            </tr>
            <tr>
